...
DOMAINS = {
    "行业动态": {
        ...
        "include_keywords": [],      # 必须包含的关键字（空=无要求）
        "exclude_keywords": ["税", "电池", "锂矿", "原材料", "油"],  # 排除关键字
        "max_count": 10,
    },
    "企业要闻": {
        "id": "enterprise",
    ...
    "新车上市": {
        "id": "newcar",
        "urls": [
            "https://auto.gasgoo.com/new-cars/C-107",   # 盖世汽车
            "https://price.pcauto.com.cn/cars/6/",        # 太平洋汽车
        ],
        "include_keywords": ["上市", "预售"],  # 盖世汽车用
        "exclude_keywords": [],
        "max_count": 10,
        "pcauto_check_date": True,  # 太平洋汽车需要判断上市日期
    },
    "宏观经济政策": {
        "id": "macro",
        "urls": [
